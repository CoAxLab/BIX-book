...
# 
# There are three other tools in python thta we will need. One is a library called _numpy_, which is the core for all scientific work in python. A nice introduction for this can be found below. (The book comes from a generally excellent reference for using python in data science.)
# 
...
# 
# We will also use a visualization / plotting library called _matplotlib_, which you can try our here:
# 
# [Python Data Science Handbook - chapter 4](https://jakevdp.github.io/PythonDataScienceHandbook/04.00-introduction-to-matplotlib.html)
# 
...
# 
# A _very_ easy way to run notebooks, and to even understand what they _are_, is to use an online service, like Google's _colaboratory_. It's a bit like Google Docs, but for python code. 
# 
# At the top of every page and assignment in this book is an _open in collab_ button. It looks like an infinity sign, sort of. If you click that button (and are on the internet) the page will open up a live python session, and you can get right to work. For more:
# 
...
# 
# ## Assignment 1
# Read through _either_ the _Cogs19_ or _Whirlwind tour_ links. If you need to read deeply, and try things out in Google Colab.
# 
# ## Assignment 2
